...
text="""hr wurdet auserwählt mir, Inquisitorin Lira Mardox und der heiligen Inquisition zu Terra vertreten durch mich, zu Dienen. Es gibt keine höhere Pflicht, denn ich diene dem Imperator und seinem Regenten direkt. 
...
Denn die Feinde der Menschheit lauern in jeder Gestalt, kein Rang, kein Privileg soll sie vor der Gerechtigkeit des Imperators schützen. Unsere Wachsamkeit soll von keiner Amts-Insignia geblendet werden, doch bedenkt, auch wenn meine Autorität absolut ist, so ist es meine Macht nicht. Und so sind Vorsicht und Heimlichkeit das mächtigste Schwert in unserem Arsenal. 
...
Wir werden mit Schlachtgruppe Fortis in den Macharian Sektor aufbrechen und zwei Hauptmissionen verfolgen. Wir werden die Schlachtgruppe vor Sabotage schützen und nach Kräften Unterstützen während wir für Lord Inquisitorin Greyfax einen Bericht über die Inquisition des Macharian Sektors und die Ereignisse nach der Langen Nacht erstellen. 

Eigentlich ist das schon alles was ihr zu eurer Mission wissen müsst und manche Inquisitoren würden es dabei belassen. Doch ich verlange von euch Vertrauen das nur gedeihen kann wenn Vertrauen gegeben wird, deswegen will ich eurer erstes Briefing mit einigen Informationen beginnen, die nur für eure Ohren bestimmt sind. Uns haben Informationen von Inquisitor Lord Hieronymo Drak erreicht und sobald die Kampfgruppe den Sektor erreicht wird Gruppenmeister Valdur Slain die Welt Belnshudha vernichten. Gleichzeitig haben wir die Nachricht an Schiffe der Navis Imperiales Macharian weitergeleitet. Aktuell bereite ich einen Bericht über den Sektor vor. Solange widmet euch euren Aufgaben und meldet euch zum Mentalen Training bei Interrogator Vassa Leondir und für das Körperliche Training bei Captain Me'an Alzius. Constable Wallfeld wird euch in der Wichtigsten Fähigkeit unterrichten, dem Studium und Recherche Imperialer Akten."""

speaker_wav="ref/Anna_Zakrisson_DE.ogg" # Pfad zu einer kurzen Aufnahme (z.B. deine eigene Stimme)
...
if os.path.exists(speaker_wav):
    ...
    print(f"FEHLER: Die Datei '{speaker_wav}' existiert nicht. Bitte nimm erst eine kurze WAV-Datei auf.")
